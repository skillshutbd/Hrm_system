...
<div class="profile-shell">
    <div class="d-flex justify-content-between align-items-start mb-4 flex-wrap gap-3">
        ...
        <a href="{{ route('hr_admin.profile') }}" class="btn-back d-flex align-items-center gap-2">
            <i class="bi bi-arrow-left"></i> Back
        </a>
    </div>

    <div class="form-card">
        <form action="{{ route('hr_profile.update') }}" method="POST">
            @csrf
            @method('PUT')
            ...
            <div class="d-flex gap-2">
                ...
                <a href="{{ route('hr_admin.profile') }}" class="btn-back">
                    Cancel
                </a>
            </div>
        </form>
