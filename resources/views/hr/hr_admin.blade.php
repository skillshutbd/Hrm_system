...
<style>
    ...
    .avatar-circle { width: 34px; height: 34px; border-radius: 50%; background: #FFF0EB; display: flex; align-items: center; justify-content: center; font-size: 0.78rem; font-weight: 700; color: #FF5E2B; flex-shrink: 0; }
    .badge-approved { background: #ECFDF5; color: #059669; font-size: 0.75rem; font-weight: 600; padding: 4px 10px; border-radius: 20px; display: inline-block; }
    .badge-pending  { background: #FFF7ED; color: #EA580C; font-size: 0.75rem; font-weight: 600; padding: 4px 10px; border-radius: 20px; display: inline-block; }
    .btn-approve { background: #FF5E2B; color: #fff; border: none; border-radius: 6px; font-size: 0.78rem; font-weight: 600; padding: 5px 12px; cursor: pointer; transition: background 0.2s; }
    .btn-approve:hover { background: #E04B1A; }
    .btn-reject { background: none; border: 1px solid #E2E0DD; color: #DC2626; border-radius: 6px; font-size: 0.78rem; font-weight: 600; padding: 5px 12px; cursor: pointer; transition: background 0.2s; }
        ...
        <div class="card kpi-card border-0 shadow-sm h-100">
            <div class="card-body p-4 d-flex flex-column justify-content-between">
                ...
                <div class="text-success d-flex align-items-center gap-1">
                    ...
                    <span style="font-size:0.8rem;">Active Employees</span>
                </div>
            </div>
        </div>
    </div>
    <div class="col-12 col-md-6 col-xl-3">
        <div class="card kpi-card border-0 shadow-sm h-100">
            <div class="card-body p-4 d-flex flex-column justify-content-between">
                ...
                <div class="text-muted" style="font-size:0.8rem;">Total Departments</div>
            </div>
        </div>
    </div>
    <div class="col-12 col-md-6 col-xl-3">
        <div class="card kpi-card border-0 shadow-sm h-100">
            <div class="card-body p-4 d-flex flex-column justify-content-between">
                ...
                <div class="text-warning d-flex align-items-center gap-1">
                    ...
                    <span style="font-size:0.8rem;">Awaiting HR Action</span>
                </div>
            </div>
        </div>
    </div>
    <div class="col-12 col-md-6 col-xl-3">
        <div class="card kpi-card border-0 shadow-sm h-100">
            <div class="card-body p-4 d-flex flex-column justify-content-between">
                ...
                <div class="text-muted" style="font-size:0.8rem;">Last actions taken</div>
            </div>
        </div>
    </div>
</div>
                    ...
                    <tr>
                        <td>
                            <div class="d-flex align-items-center gap-2">
                                ...
                                <div>
                                    <div style="font-weight:600;">{{ $leave->employee->name ?? 'N/A' }}</div>
